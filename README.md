...
Here I built a beginner machine learning project. It included creating a hypothesis, setting up the model, and measuring error. By the end, I understood  how to build an end-to-end machine learning project using Python and Jupyter.
